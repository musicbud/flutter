...
class AppConstants {
  // Colors
  static const Color primaryColor = DesignSystem.primaryContainer;
  static const Color backgroundColor = DesignSystem.background;
  static const Color surfaceColor = DesignSystem.surfaceContainer;
  static const Color textColor = DesignSystem.onSurface;
  static const Color textSecondaryColor = DesignSystem.onSurfaceVariant;
  static const Color borderColor = DesignSystem.borderLight;
  static const Color errorColor = DesignSystem.error;
  static const Color successColor = DesignSystem.success;
