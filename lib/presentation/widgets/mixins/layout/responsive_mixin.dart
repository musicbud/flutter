...
mixin ResponsiveMixin<T extends StatefulWidget> on State<T> {
  ...
  EdgeInsetsGeometry responsivePadding({
    ...
    const defaultMobile = EdgeInsets.all(16.0);
    const defaultTablet = EdgeInsets.all(24.0);
    const defaultDesktop = EdgeInsets.all(32.0);
  ...
  EdgeInsetsGeometry responsiveMargin({
    ...
    const defaultMobile = EdgeInsets.all(8.0);
    const defaultTablet = EdgeInsets.all(16.0);
    const defaultDesktop = EdgeInsets.all(24.0);
    ...
    return responsiveValue<EdgeInsetsGeometry>(
      ...
      tablet: tablet ?? defaultTablet,
      desktop: desktop ?? defaultDesktop,
      largeDesktop: largeDesktop ?? const EdgeInsets.all(32.0),
    );
  }
  ...
  BorderRadius responsiveBorderRadius({
    ...
    final defaultMobile = BorderRadius.circular(4.0);
    final defaultTablet = BorderRadius.circular(8.0);
    final defaultDesktop = BorderRadius.circular(12.0);
    ...
    return responsiveValue<BorderRadius>(
      ...
      tablet: tablet ?? defaultTablet,
      desktop: desktop ?? defaultDesktop,
      largeDesktop: largeDesktop ?? BorderRadius.circular(16.0),
    );
  }
  ...
  TextOverflow responsiveOverflow({
    required BuildContext context,
    required TextOverflow mobile,
    TextOverflow? tablet,
    TextOverflow? desktop,
    TextOverflow? largeDesktop,
  }) {
    return responsiveValue<TextOverflow>(
      context: context,
      mobile: mobile,
      tablet: tablet ?? mobile,
      desktop: desktop ?? mobile,
